    ...
    <Box sx={{ bgcolor: props.bg }}>
      <Container id='vpn' sx={{ maxWidth: 'xl', py: 8 }}>
        ...
        <Typography color='text.primary'>
          ...
          the overwelming amount of YouTubers and Web Articles spreading all
          ...
          works it is obvious that these influeners are lying and just tyring to
          ...
          do it, if their promises of a no log policy is witheld. <br /> <br />{' '}
          ...
          paritcular game are not always avaiable to us. A common solution is to
          use a VPN to squeeze in a few extra miliseconds ping and a more stable
          ...
          compromsing any of my activity. Another bonus of using my own service
          ...
          to the location where my VPN is regesiterd unless I subcribe to more
        ...
        <Typography color='text.primary'>
          ...
          sure how it worked and throug the process I aquired some knowledge how
